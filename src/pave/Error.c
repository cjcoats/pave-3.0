 ...
 *  PAVE Version 3.0
 *
 *  File: $Id: Error.c 83 2018-03-12 19:24:33Z coats $
...
static const char SVN_ID[] = "$Id: Error.c 83 2018-03-12 19:24:33Z coats $";
...
void error ( const char* message, ... )
    ...
    int errnoTmp = errno;
    enum { MAX_MESSAGE_SIZE = 10240 };
    static char expandedMessage[ MAX_MESSAGE_SIZE ]; /* BUG: Big enough?... */
    ...
    else         strcat ( expandedMessage, "User or data error." );

    strcat ( expandedMessage, "\n(See console window for more details.)" );

    CHECK ( strlen ( expandedMessage ) < MAX_MESSAGE_SIZE );
