 ...
 *  PAVE Version 2.4
 *
 *  File: $Id: Browser.h 84 2018-03-12 21:26:53Z coats $
 ...
 *     OTHER NOTES: :-)
 *
 * VERSION "$Id: Browser.h 84 2018-03-12 21:26:53Z coats $"
 ********************************************************************
 *
...
static char *vhBrowser = "$Id: Browser.h 84 2018-03-12 21:26:53Z coats $" ;
#endif
...
void rem_dir_search(Widget widget, XtPointer search_data);
void file_search(Widget widget, XtPointer search_data);
void UpdateDirWidget (Widget widget, int nitems, char **fileList);
void UpdateFileWidget (Widget widget, int nitems, char **fileList);
